...
Sub saveData(inp As String)
    ...
    mapper.Add "at", "taxi"
    mapper.Add "al", "auto-lower"
    mapper.Add "au", "auto-upper"
    mapper.Add "ac", "autoCargo"
    mapper.Add "tu", "tele-upper"
    mapper.Add "tl", "tele-lower"
    mapper.Add "wd", "wasDefended"
    mapper.Add "def", "defend?"
    mapper.Add "ss", "shootingSpots"
    mapper.Add "c", "climb"
    mapper.Add "lsr", "LSR"
    mapper.Add "be", "earlyClimb"
    mapper.Add "ds", "driverSkill"
    mapper.Add "dr", "defRating"
    mapper.Add "d", "died?"
    mapper.Add "cf", "fouls"
